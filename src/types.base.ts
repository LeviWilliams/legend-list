...
export interface LegendListPlatformTypes {
...
interface LegendListSpecificProps<
    ItemT,
    TItemType extends string | undefined,
    TPlatform extends LegendListPlatformTypes,
> {
    /**
     ...
     */
    ListFooterComponentStyle?: TPlatform["StyleProp"] | undefined;
     ...
     */
    ListHeaderComponentStyle?: TPlatform["StyleProp"] | undefined;
    ...
    onScroll?: (event: TPlatform["NativeSyntheticEvent"]) => void;
     ...
     */
    refScrollView?: React.Ref<TPlatform["ScrollView"]>;
     ...
     */
    renderScrollComponent?: (props: TPlatform["ScrollViewProps"]) => React.ReactElement<TPlatform["ScrollViewProps"]>;
...
export type LegendListPropsBaseInternal<
    ItemT,
    TScrollViewProps,
    TPlatform extends LegendListPlatformTypes,
    TItemType extends string | undefined = string | undefined,
> = BaseScrollViewProps<TScrollViewProps> &
    LegendListSpecificProps<ItemT, TItemType, TPlatform> &
...
type LegendListPropsForState<TPlatform extends LegendListPlatformTypes> = LegendListPropsBaseInternal<
    any,
    TPlatform["ScrollViewProps"],
    TPlatform
>;

export interface InternalStateBase<TPlatform extends LegendListPlatformTypes> {
    ...
    lastLayout: TPlatform["LayoutRectangle"] | undefined;
    ...
    refScroller: React.RefObject<TPlatform["ScrollView"]>;
    scroll: number;
    ...
    props: {
        alignItemsAtEnd: boolean;
        animatedProps: StylesAsSharedValue<TPlatform["ScrollViewProps"]>;
        contentInset: TPlatform["Insets"] | undefined;
        data: readonly any[];
        dataVersion: Key | undefined;
        estimatedItemSize: number | undefined;
        getEstimatedItemSize: LegendListPropsForState<TPlatform>["getEstimatedItemSize"];
        getFixedItemSize: LegendListPropsForState<TPlatform>["getFixedItemSize"];
        getItemType: LegendListPropsForState<TPlatform>["getItemType"];
        horizontal: boolean;
        initialContainerPoolRatio: number;
        itemsAreEqual: LegendListPropsForState<TPlatform>["itemsAreEqual"];
        keyExtractor: LegendListPropsForState<TPlatform>["keyExtractor"];
        maintainScrollAtEnd: boolean | MaintainScrollAtEndOptions;
        maintainScrollAtEndThreshold: number | undefined;
        maintainVisibleContentPosition: MaintainVisibleContentPositionNormalized;
        numColumns: number;
        onEndReached: LegendListPropsForState<TPlatform>["onEndReached"];
        onEndReachedThreshold: number | null | undefined;
        onItemSizeChanged: LegendListPropsForState<TPlatform>["onItemSizeChanged"];
        onLoad: LegendListPropsForState<TPlatform>["onLoad"];
        onScroll: LegendListPropsForState<TPlatform>["onScroll"];
        onStartReached: LegendListPropsForState<TPlatform>["onStartReached"];
        onStartReachedThreshold: number | null | undefined;
        onStickyHeaderChange: LegendListPropsForState<TPlatform>["onStickyHeaderChange"];
        recycleItems: boolean;
        renderItem: LegendListPropsForState<TPlatform>["renderItem"];
        scrollBuffer: number;
...
export type LegendListStateBase<TPlatform extends LegendListPlatformTypes> = {
    activeStickyIndex: number;
    contentLength: number;
    data: readonly any[];
    elementAtIndex: (index: number) => TPlatform["View"] | null | undefined;
    end: number;
    endBuffered: number;
    isAtEnd: boolean;
    isAtStart: boolean;
...
export type LegendListRefBase<TPlatform extends LegendListPlatformTypes> = {
    /**
     ...
     */
    getNativeScrollRef(): TPlatform["ScrollViewRef"];
     ...
     */
    getScrollResponder(): TPlatform["ScrollResponderMixin"];

    /**
     * Returns the internal state of the scroll virtualization.
     */
    getState(): LegendListStateBase<TPlatform>;
